class Constants {
  static const String key =
      '563492ad6f91700001000001a3849735bf71466098899cd51f80572b';

  static const String baseURL =
      'https://api.pexels.com/v1/curated?per_page=15&page=1';

  static const String searchBaseURL = 'https://api.pexels.com/v1/search?query=';

  static const List categoriesImg = [
  ...
  static const List categoriesTitle = [
    "Abstract",
    'Fashion',
    "Food",
    "India",
